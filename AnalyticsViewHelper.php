...
class AnalyticsViewHelper extends AbstractHelper
{
    ...
    private $templates = [
        ...
        'journee_etudes' => 121,
        'retour_experience' => 110,
        'retour_experience_etudiant' => 128,
        'laboratoire' => 91,
        'mediaMiara' => 100,
        'mediagraphie' => 83,
        'microResumeIA' => 125,
    ...
    private $typeLabels = [
        ...
        'journee_etudes' => 'Journees d\'etude',
        'retour_experience' => 'Retours d\'experience',
        'retour_experience_etudiant' => 'Retours d\'experience (Etudiant)',
        'laboratoire' => 'Laboratoires',
        'mediaMiara' => 'Medias MIARA',
        'mediagraphie' => 'Mediagraphies',
        'microResumeIA' => 'Micro resumes IA',
        'recit_artistique' => 'Oeuvres',
        'outil' => 'Outils',
        'outil_etudiant' => 'Outils (Etudiant)',
        'pays' => 'Pays',
        'personneExterne' => 'Personnes externes',
        'recherche' => 'Recherches',
        'recitArtistique' => 'Recits artistiques',
        'recit_citoyen' => 'Recits Citoyens',
        'recit_mediatique' => 'Recits Mediatiques',
        'recit_scientifique' => 'Recits Scientifiques',
        'recit_techno_industriel' => 'Recits Techno-Industriels',
        'seance' => 'Seances',
