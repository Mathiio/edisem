...
export const CourseManagement: React.FC<CourseManagementProps> = ({ embedded = false }) => {
          ...
          <TableBody emptyContent='Aucun cours'>
            {courses.map((course) => (
              <TableRow key={course.id}>
                ...
                <TableCell>
                  <Chip size='sm' variant='flat' color={course.studentCount > 0 ? 'primary' : 'default'} className='cursor-pointer' onClick={() => handleViewStudents(course)}>
