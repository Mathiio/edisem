  ...
  return (
    <>
      <div className='w-full flex flex-col gap-vs'>
        <div className='font-semibold text-title'>Théorie des Graphes et Optimisation Combinatoire</div>
        <Link
          className='text-secondary-400 text-other hover:opacity-100 text-secondary'
          isExternal
          href='https://youtu.be/56STvMBKYdw'
          showAnchorIcon>
          Hao Li, Université Paris Sud, Allemagne
        </Link>
        <div className='text-other'>12 octobre 2023</div>
      </div>
