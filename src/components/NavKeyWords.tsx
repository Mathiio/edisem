  ...
  for (let i = 0; i < numberOfButtons; i++) {
    buttons.push(
      <Button
        ...
        onClick={onClick}
        radius='none'
        className=' px-0 text-16 h-[32px] rounded-8 font-regular bg-transparent border-2 border-default-300 hover:border-default-action hover:opacity-100 text-default-400 hover:text-default-action transition-all ease-in-out duration-200 navkeyword'>
        Press me
      </Button>,
    );
  }
