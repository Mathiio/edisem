  ...
  return (
    <div className='w-full lg:h-[400px] xl:h-[450px]  sm:h-[450px] '>
      <Scrollbar withGap>
        <motion.div className='flex flex-col gap-25' initial='hidden' animate='visible' variants={containerVariants}>
          <motion.div key={0} variants={itemVariants}>
            <BibliographieCard author={`Rastier F.`} content={`Autour de la « post-vérité », de menaçantes convergences. Dans Maryvonne Holzem (éd.), Vérités citoyennes. Les sciences contre la post-vérité. Éditions du Croquant.`} year={2019} />
          </motion.div>
          <motion.div key={1} variants={itemVariants}>
            <BibliographieCard author={`Morin E.`} content={`Le Cinéma ou l'Homme imaginaire : Essai d'anthropologie. Éditions de Minuit.`} year={1956} />
          </motion.div>
          <motion.div key={2} variants={itemVariants}>
            <BibliographieCard author={`Guilyardi E.`} content={`Qu'est-ce qu'un fait en sciences physiques naturelles?. Dans Proust, S. et Lecointre, G. (dir.), Le fait en question. Éditions de l'Aube.`} year={2019} />
          </motion.div>
          <motion.div key={3} variants={itemVariants}>
            <BibliographieCard author={`Bergeron P.`} content={`Deepfake : distinguer le vrai du faux sur les implications juridiques d'une technologie « trompeuse ». Dans Barreau du Québec, Service de la formation continue, Développements récents en droit de la propriété intellectuelle (pp. 205-257). Éditions Yvon Blais.`} year={2020} />
          </motion.div>
          <motion.div key={4} variants={itemVariants}>
            <BibliographieCard author={`Guilyardi E.`} content={`Qu'est-ce qu'un fait en sciences physiques naturelles?. Dans Proust, S. et Lecointre, G. (dir.), Le fait en question. Éditions de l'Aube.`} year={2019} />
          </motion.div>
