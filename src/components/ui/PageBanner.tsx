...
export const PageBanner = ({ 
  ...
  return (
    <div className={`pt-100 justify-center flex items-center flex-col gap-20 relative ${className}`}>
      <div className='gap-20 justify-between flex items-center flex-col'>
        {/* Icon */}
        {icon && <div className='text-c4'>{icon}</div>}

        {/* Title */}
        <h1 className='z-[12] text-64 text-c6 font-medium flex flex-col items-center text-center'>
          {title}
        </h1>
