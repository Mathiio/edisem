...
export type RecitType = 'recitCitoyen' | 'recitMediatique' | 'recitScientifique' | 'recitTechnoIndustriel';
...
export const RecitCard: React.FC<RecitCardProps> = (props) => {
  ...
  const getTypeBadgeLabel = () => {
       switch (type) {
          case 'recitCitoyen': return 'Récit Citoyen';
          case 'recitMediatique': return 'Récit Médiatique';
          case 'recitScientifique': return 'Récit Scientifique';
          case 'recitTechnoIndustriel': return 'Récit Techno-Industriel';
  ...
  const getTypeBadgeColor = () => {
       switch (type) {
          case 'recitCitoyen': return '#C8E6C9'; 
          case 'recitMediatique': return '#FFF1B8'; 
          case 'recitScientifique': return '#AFC8FF'; 
          case 'recitTechnoIndustriel': return '#A9E2DA'; 
