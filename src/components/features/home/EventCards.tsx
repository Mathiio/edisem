...
export const EventCard: React.FC<EventCardProps> = ({ id, title, numConf }) => {
  ...
  return (
    <div
      onClick={openEdition}
      className="shadow-[inset_0_0px_50px_rgba(255,255,255,0.06)] border-c3 border-2 cursor-pointer p-40 rounded-30 justify-between flex flex-col gap-20 hover:bg-c2 h-full transition-all ease-in-out duration-200"
    >
