...
export const HomeBaner: React.FC = () => {
  return (
    <div className='pt-36 justify-center flex items-center flex-col gap-8'>
      {/* Main title with gradient highlight */}
      <div className='gap-8 justify-between flex items-center flex-col'>
        {/* Main title */}
        <h1 className='z-[12] text-6xl text-c6 font-medium flex flex-col items-center transition-all ease-in-out duration-200 '>
