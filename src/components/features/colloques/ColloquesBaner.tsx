...
interface ColloquesBanerProps {
  colloques: any[];
}

export const ColloquesBaner = ({ colloques }: ColloquesBanerProps) => {
  // Count stats
  const totalConferences = colloques.length;
  const totalEditions = new Set(colloques.map((conf: any) => conf.edition)).size;
