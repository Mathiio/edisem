                    ...
                    <div className='w-full flex flex-col gap-50'>
                      {filteredConfs.length > 0 && !loadingConfs && (
                        <div className='w-full flex flex-col gap-20'>
                          <h2 className='text-24 font-medium text-c6'>Conférence{filteredConfs.length > 1 ? 's' : ''}</h2>
                      ...
                      {filteredActants.length > 0 && !loadingActants && (
                        <div className='w-full flex flex-col gap-20'>
                          <h2 className='text-24 font-medium text-c6'>Intervenant{filteredActants.length > 1 ? 's' : ''}</h2>
                          <div className='w-full flex flex-col gap-10'>
                            {loadingActants
                      ...
                      {hasSearched && filteredActants.length === 0 && filteredConfs.length === 0 && !loadingActants && !loadingConfs && (
