        ...
        {conferences.map((item, index) => (
          ...
          >
            <ConfCard
              ...
              url={item.url}
              universite={
                item.actant && item.actant.universities && item.actant.universities.length > 0 
                  ...
                  <div className={`relative ${hasSearched ? 'overflow-scroll' : 'hidden'}`}>
                    <motion.main className='w-full py-20 transition-all ease-in-out duration-200' initial='hidden' animate='visible' variants={fadeIn}>
                      <div className='w-full flex flex-col gap-50'>
                        ...
                        <ConferenceSection
                          conferences={filteredConferences.seminars}
                        ...
                        <ConferenceSection
                          conferences={filteredConferences.studyDays}
                        ...
                        <ConferenceSection
                          conferences={filteredConferences.colloques}
